...
def makeWebhookResult(data,data_1):
    ...
    speech = "address of the office is " + formatted_address_1 +\n+ "--------phone no is "+phone+ "_______________________________________________________________________"+ "_______daily opening hours"+ "___________________________________________________________________________"+weekday
